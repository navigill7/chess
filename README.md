...
└─────────────┬───────────────────────────┬───────────────────┘
              ...
              │                           │
┌─────────────▼───────────────┐  ┌───────▼──────────────────┐
│   Main Server (Django)      │  │  Chess Bot (Django)      │
│   http://localhost:8000     │  │  http://localhost:8001   │
│                             │  │                          │
│  • P2P Game Management      │  │  • AI Move Generation    │
│  • WebSocket (Daphne)       │  │  • Position Evaluation   │
│  • User Authentication      │  │  • Move Validation       │
│  • Matchmaking System       │  │  • Difficulty Levels     │
│  • Game History             │  │                          │
└─────────────┬───────────────┘  └──────────────────────────┘
              │
              │
...
│                    Celery Workers                            │
│                                                              │
│  • Celery Worker:  Async matchmaking tasks                  │
...
│                             │  │                          │
│  • WebSocket channels       │  │  • User data             │
│  • Celery task queue        │  │  • Game records          │
│  • Session cache            │  │  • Matchmaking queue     │
└─────────────────────────────┘  └──────────────────────────┘
```
